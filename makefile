ifeq ($(platform),)
	platform = switch
else ifneq ($(platform), vita)
	echo "When using this makefile,"
	echo "platform must be either switch (default) or vita"
	echo "e.g. `make platform=vita` or `make platform=switch`"
endif
